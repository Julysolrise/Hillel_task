...
def measure_exec_time(func):
    # use wraps to save original func name
    @wraps(func)
    # create a wrapper func that will be returned instead of the original func
    def wrapper(*args, **kwargs):
        # get date before calling function
        start = datetime.now()
        # call function
        res = func(*args, **kwargs)
        # get date after calling function
        end = datetime.now()
